...
const projects: MockProjectRecord[] = [
  ...
  },
  {
    id: 104,
    name: "04 · 考频已分析｜操作系统",
    description: "包含多年份真题、待处理试卷和长考频列表，用于考频页完整状态。",
    ...
    documents: [
      ...
      },
      {
        ...
        displayName: "2022-2023 学年操作系统期末试卷.pdf",
        documentType: "PAST_EXAM",
        status: "READY",
        pageCount: 8,
        chunkCount: 31,
      },
      {
        ...
        displayName: "2023-2024 学年操作系统期末试卷.pdf",
        documentType: "PAST_EXAM",
        status: "READY",
        pageCount: 11,
        chunkCount: 42,
      ...
      {
        id: 404,
        indexId: "10000000-0000-4000-8000-000000000404",
        displayName: "2024-2025 学年操作系统期末试卷（补考试卷）.pdf",
        documentType: "PAST_EXAM",
        status: "PROCESSING",
        pageCount: 14,
        chunkCount: 0,
    ...
    qaSession: null,
    knowledgePoints: [
      { knowledgePoint: "进程调度", questionCount: 18 },
      { knowledgePoint: "虚拟内存与页面置换", questionCount: 15 },
      { knowledgePoint: "进程同步与信号量", questionCount: 13 },
      { knowledgePoint: "死锁检测、避免与解除", questionCount: 9 },
      { knowledgePoint: "文件系统与磁盘调度", questionCount: 7 },
      { knowledgePoint: "进程与线程", questionCount: 6 },
      { knowledgePoint: "I/O 系统", questionCount: 4 },
      { knowledgePoint: "操作系统引导与系统调用", questionCount: 2 },
    ],
    analyses: [
      {
        documentId: 402,
        detectedQuestions: 24,
        analyzedQuestions: 22,
        needsReviewQuestions: 2,
      },
      {
        documentId: 403,
        detectedQuestions: 28,
        analyzedQuestions: 27,
