...
public class KnowledgePointNormalizer {
  ...
  static {
    ...
    DICTIONARY.put("排序算法", List.of("sorting", "sort", "insertion sort", "merge sort", "radix sort", "heap sort", "counting sort"));
    ...
    DICTIONARY.put("极限", List.of("limit", "limits", "极限"));
    ...
    DICTIONARY.put("数列", List.of("sequence", "subsequence", "数列", "子列"));
